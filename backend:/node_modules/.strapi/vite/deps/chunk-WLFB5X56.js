...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-PS3BWTTH.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-7YT2YD57.js").then((mod) => ({
          default: mod.App
        })),
...
//# sourceMappingURL=chunk-WLFB5X56.js.map
